...
type PropsType = {
    ...
    changeFilter: (todoId:number,value: FilterValuesType) => void
    addTask: (todoId:number,title: string) => void
    changeTaskStatus: (todoId:number,taskId: string, isDone: boolean) => void
    removeTodoList:(todoId:number) => void
...
export function Todolist(props: PropsType) {
    ...
    return <div>
        <h3>{props.title}
            <button onClick={onClickHandlerTodo}>x</button>
        </h3>
